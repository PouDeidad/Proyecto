...
<body onload="IniciarSecuencia()">
    ...
    <script>
        ...
        <div class="apoco">
            <p>La forma para saber calcular el costo del uber es primero la tarifa mnima es de 35 pesos y por cada 1000 mts o 1km cobra 35.78 pesos</p>
        ...
        <?php
            ...
            if (isset($_POST['continuar'])) {
                ...
                mysqli_query($enlace, "INSERT INTO rep_sem (Id, Fecha, Costo, Distancia, TipoTransporte) VALUES ($nuevoId, '$fecha', $total, $distancia, 'Uber')");
