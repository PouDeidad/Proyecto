...
<body onload="IniciarSecuencia()">
    ...
    <script>
        ...
        <div class="apoco">
            <p>La forma para saber calcular el costo del taxi es primero la tarifa de 15 pesos y por cada 1000 mts o 1km cobra 3.6 pesos</p>
        ...
        <?php
            ...
            if (isset($_POST['continuar'])) {
                ...
                mysqli_query($enlace, "INSERT INTO rep_sem (Id, Fecha, Costo, Distancia, TipoTransporte) VALUES ($nuevoId, '$fecha', $total, $distancia, 'Taxi')");
